...
class $AssetsRawGen {
  ...
  /// File path: assets/raw/send_email.json
  LottieGenImage get sendEmail =>
      const LottieGenImage('assets/raw/send_email.json');

  /// List of all assets
  List<LottieGenImage> get values => [sendEmail];
}
